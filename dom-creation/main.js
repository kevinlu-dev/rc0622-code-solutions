...
function renderPokemon(pokemon) {
  ...
  var pokeHeadingTwo = document.createElement('h2');
  var pokeName = document.createTextNode(pokemon.name);
  pokeHeadingTwo.appendChild(pokeName);
  pokeCardText.appendChild(pokeHeadingTwo);

  var pokeHeadingThree = document.createElement('h3');
  var pokeNumber = document.createTextNode(pokemon.number);
  pokeHeadingThree.appendChild(pokeNumber);
  pokeCardText.appendChild(pokeHeadingThree);

  var pokeParagraph = document.createElement('p');
  var pokeDescription = document.createTextNode(pokemon.description);
  pokeParagraph.appendChild(pokeDescription);
  pokeCardText.appendChild(pokeParagraph);
...
for (let i = 0; i < pokedex.length; i++) {
  ...
  rowData.appendChild(pokedexLoop);
}
